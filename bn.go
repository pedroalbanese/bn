// Parameters for the Fp256BN & Fp512BN (Barreto-Naehrig curves)
package bn
...
func initP256() {
	...
	p256.B, _ = new(big.Int).SetString("03", 16)
	p256.Gx, _ = new(big.Int).SetString("01", 16)
	p256.Gy, _ = new(big.Int).SetString("02", 16)
	p256.BitSize = 256
}
...
func initP512() {
	p512 = new(Curve)
	p512.P, _ = new(big.Int).SetString("fffffffffffffffffffffffffff9ec7f01c60ba1d8cb5307c0bbe3c111b0ef455146cf1eacbe98b8e48c65deab236fe1916a55ce5f4c6467b4eb280922adef33", 16)
	p512.N, _ = new(big.Int).SetString("fffffffffffffffffffffffffff9ec7f01c60ba1d8cb5307c0bbe3c111b0ef445146cf1eacbe98b8e48c65deab2679a34a10313e04f9a2b406a64a5f519a09ed", 16)
	p512.B, _ = new(big.Int).SetString("03", 16)
	p512.Gx, _ = new(big.Int).SetString("01", 16)
	p512.Gy, _ = new(big.Int).SetString("02", 16)
	p512.BitSize = 512
}
